...
-- AI ASSISTED : nub was a library suggested to me
-- ### 2.1 Prime ### --
prime :: Int -> Bool
prime n
  = factors n == [1,n]
...
selector2 [a,b,c,d] = 
    ...
    -- AI ASSISTED : anonymous function suggested for framework
    in prime m && prime n && any (\[x,y] -> length (nub [a,b,c,d,x,y]) == 6) initialHand

--The expected result is within the list of outputs, however I could not find a logical way to constrain the
--selector further to remove all results up until [7,23,31,37]
-- ### Main ### --
main :: IO()
main = 
